...
export const COURSES = [
    {
        ...
        subjects: [{ id: 1, name: "Lập trình Java" }], enrollmentCount: 245,
    ...
    },
    {
        ...
        subjects: [{ id: 3, name: "Lập trình Web" }], enrollmentCount: 189,
    ...
    },
    {
        ...
        subjects: [{ id: 5, name: "Trí tuệ nhân tạo" }], enrollmentCount: 312,
    ...
    },
    {
        ...
        subjects: [{ id: 4, name: "Cơ sở dữ liệu" }], enrollmentCount: 156,
    ...
    },
    {
        ...
        subjects: [{ id: 8, name: "An toàn thông tin" }], enrollmentCount: 98,
    ...
    },
    {
        ...
        subjects: [{ id: 5, name: "Trí tuệ nhân tạo" }], enrollmentCount: 420,
