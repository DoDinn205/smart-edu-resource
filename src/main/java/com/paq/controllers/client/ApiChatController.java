...
public class ApiChatController {
    ...
    @GetMapping("/secure/chat-rooms/{id}")
    ...
    @PutMapping("/secure/chat-rooms/{id}")
    ...
    @DeleteMapping("/secure/chat-rooms/{id}")
    ...
    @GetMapping("/secure/chat-rooms/{roomId}/participants")
    ...
    @PostMapping("/secure/chat-rooms/{roomId}/participants")
    ...
    @DeleteMapping("/secure/chat-participants/{id}")
