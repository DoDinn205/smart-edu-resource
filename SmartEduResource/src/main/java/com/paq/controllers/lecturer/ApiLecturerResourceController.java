...
public class ApiLecturerResourceController {
    ...
    public ResponseEntity<ResResponse<ResPageDTO<ResResourceDTO>>> getLecturerResources(@org.springframework.web.bind.annotation.RequestParam Map<String, String> params) {
        ...
        ResPageDTO<ResResourceDTO> pageDTO = com.paq.utils.DTOMapper.toResPageDTO(this.resourceService.getLecturerResources(params), totalItems, page, pageSize);
